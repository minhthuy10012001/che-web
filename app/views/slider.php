                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="<?php echo BASE_URL ?>/public/images/traolong.jpg" alt="Siêu khuyến mãi" width="100%">
                        </div>

                        <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/2.jpeg" alt="Siêu khuyến mãi" width="100%">
                        </div>
                        ...
                        <div class="item">
                         ...
                         <div class="item">
                            <img src="<?php echo BASE_URL ?>/public/images/4.png" alt="Siêu khuyến mãi" width="100%">
                        </div>
                    </div>
